<template>
    <b-modal id="help-config-document">
        ...
        <div>
            @lang('Haga click en aquellas partes del documento que requieran una firma')
        </div>

        <div class="mt-2">
            @lang('Luego seleccione el firmante de la lista'). 
            @lang('Para cada firma se generará una clave criptográfica única')
        </div>
