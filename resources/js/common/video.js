...
new Vue({
	...
	data: {
        ...
        pause: false,                           // true si pausado el video, false en caso contrario
		mediaRecorder: null,                    // El mediarecorder

		timer: null,                            // El cronómetro
		time: 0,                                // El tiempo en segundos de la grabación
		maxTime: video.dataset.maxRecordTime,   // El máximo tiempo que se puede grabar en segundos
	...
	methods: {
		...
		save: function(event) {
			...
			// Envía las grabaciones de video
			HoldOn.open({ theme: "sk-circle" });
			Axios.post(request.save, {
				videos: $this.videos, // Las grabaciones de video
