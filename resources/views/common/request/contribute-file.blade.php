...
<div class="main-card mb-3 card">
	...
	{{--Selección de documento a aportar--}}
    ...
    <div v-if="aportedDocuments.length == documents.length" class="card-body">
    	<span class="text-success bold">
    		@lang('Ya usted ha seleccionado todos los documentos que se le han requerido').
    	</span>
    </div>
    {{--Mensaje de que todo ha sido aportado--}}
