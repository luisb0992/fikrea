    ...
    <div class="main-card card">
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    @forelse ($document->sharings as $sharing)
                    <tr>
...
<div  class="col-md-12 mt-4 mb-4 text-right">
    {{--
        Sólo se puede hacer un reenvío del documento diariamente

        Si el documento ya ha sido enviado hoy, el botón se mostrará deshabilitado
    --}}
    @if ($document->sharingHasBeenSentToday())
    <button class="btn btn-success disabled no-events">
        <i class="fas fa-ban"></i>
        @lang('Envío Realizado')
    </button>
    @else
    <button @click.prevent="sendDocument" :disabled="documentWasSharing" data-send-document-request="@route('dashboard.document.send.request', ['id' => $document->id])" class="btn btn-success">
