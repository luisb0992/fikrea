            ...
            <div class="card-body">
                ...
                <div class="table-responsive">    
                    <table class="mb-0 table table-striped">
                        ...
                        <tbody>
                            @forelse($fileSharing->histories as $history)
                            <tr>
                                ...
                                <td class="text-center" data-label="@lang('Ubicación Aproximada') *">
                                        @if ($history->position->country && $history->position->city)
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-s-12">
                                                    <a target="_blank" class="btn btn-primary square" href="https://www.google.com/maps/search/?api=1&query={{$history->position->latitude}},{{$history->position->longitude}}">
                        ...
                        <caption class="text-right text-secondary small">
                            <span class="bold">*</span> @lang('Ubicación aproximada en relación a la dirección ip utilizada en la conexión')
                        </caption>
                    </table>
